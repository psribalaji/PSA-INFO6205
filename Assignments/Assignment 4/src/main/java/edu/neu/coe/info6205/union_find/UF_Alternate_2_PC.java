...
public class UF_Alternate_2_PC {
    ...
    public static void main(String args[]){
        ...
        System.out.format("Weighted QuickUnion by storing the size. To connect 100000 sites it takes %.2f milliseconds\n",
        ...
        System.out.format("Weighted quick union with double path compression. TO connect 100000 sites it takes %.2f milliseconds\n",
